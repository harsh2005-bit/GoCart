...
const Footer = () => {
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+91 7667161841", path: '/', icon: MailIcon },
                { text: "harshjhabksc@gmail.com", path: '/', icon: PhoneIcon },
                { text: "Jalandhar Punjab", path: '/', icon: MapPinIcon }
            ]
        }
    ];
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © gocart All Right Reserved. Made with ❤️ by Harsh.
                </p>
            </div>
        </footer>
    );
